public class SayurSayuran extends HasilTani {
    public SayurSayuran(String kodeHasilTani, String jenisHasilTani, double beratPanen, double hargaPerKg, String tanggalPanen) {
